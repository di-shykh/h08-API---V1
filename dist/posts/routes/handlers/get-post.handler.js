...
function getPostHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const post = yield posts_query_repository_1.postsQueryRepository.findPostByIdOrFail(id);
            const postOutput = posts_query_repository_1.postsQueryRepository.mapToPostOutput(post);
