...
exports.registrationEmailResendingHandler = registrationEmailResendingHandler;
...
function registrationEmailResendingHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (result.status !== result_code_1.ResultStatus.Success) {
                if (result.status === result_code_1.ResultStatus.BadRequest) {
                    return res.status(http_statuses_1.HttpStatus.BadRequest).json({
                        errorsMessages: result.extensions
                    });
                }
                return res.status((0, resultCodeToHttpExeptions_1.resultCodeToHttpException)(result.status)).json({
                    errorsMessages: result.extensions || []
                });
            }
...
//# sourceMappingURL=registration-email-resending.handler.js.map