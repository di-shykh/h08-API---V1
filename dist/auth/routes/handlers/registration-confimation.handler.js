...
function registrationConfirmationHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const codeFromEmail = req.body.code;
            const result = yield auth_service_1.authService.confirmUserRegistration(codeFromEmail);
...
//# sourceMappingURL=registration-confimation.handler.js.map